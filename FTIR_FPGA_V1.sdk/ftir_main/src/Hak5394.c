...
void Hak5394_PL_init() {
	...
	Hak5394_WriteReg((u32) 3, (u32) 0);	//复位AD芯片
	usleep(1000);//停机等待，保证上电初始状态一致
	Hak5394_WriteReg((u32) 3, (u32) 1);	//开启AD芯片
	//Hak5394_WriteReg((u32)14,(u32) 6000);//设置硬件数据生成间隔

	Hak5394_WriteReg((u32) 13, (u32) 1);	//开启硬件采集数据
	Hak5394_Enable_McuSetLf(1);//使能MCU控制LF398 ==================
	Hak5394_SetLfHigh();//开启LF398   ============================
}
/*************************************************************************************************************************************/
/**
 * 写控制寄存器和控制数据
